...
function build_network(inputChannels, upscaleFactor, numRecursions)
    ...
    net1:add(nn.SpatialReplicationPadding(5))
    net1:add(nn.SpatialConvolution(inputChannels, 6, 11, 11, 1, 1))
    net1:add(nn.ReLU())
    net1:add(nn.SpatialReplicationPadding(3))
    net1:add(nn.SpatialConvolution(6, 6, 7, 7, 1, 1))
    net1:add(nn.ReLU())
    net1:add(nn.SpatialReplicationPadding(1))
    net1:add(nn.SpatialConvolution(6, 12, 3, 3, 1, 1))
    net1:add(nn.ReLU())
    net1:add(nn.SpatialReplicationPadding(2))
    net1:add(nn.SpatialConvolution(12, 16, 5, 5, 1, 1))
    net1:add(nn.ReLU())
    net1:add(nn.SpatialReplicationPadding(1))
    net1:add(nn.SpatialConvolution(16, 32, 3, 3, 1, 1))
    net1:add(nn.ReLU())
    net1:add(nn.SpatialReplicationPadding(1))
    ...
    innerNet:add(nn.SpatialReplicationPadding(4))
    innerNet:add(nn.SpatialConvolution(3, channels, 9, 9, 1, 1))
    innerNet:add(nn.ReLU())
    innerNet:add(nn.SpatialReplicationPadding(2))
    innerNet:add(nn.SpatialConvolution(channels, channels, 5, 5, 1, 1))
    innerNet:add(nn.ReLU())
    innerNet:add(nn.SpatialReplicationPadding(2))
